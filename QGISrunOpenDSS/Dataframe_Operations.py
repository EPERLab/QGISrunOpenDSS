...
def plot_dataframe(dataframe, titulo_grafico, output_file="",
				   titulo_ventana="",  x_label="", y_label="",
				   rotacion=0, save_csv=False, legend=""):
    try:
        import pandas as pd
...
if __name__ == "__main__":
    ...
    print(dataframe)
    fecha = "01/01/2016"
    titulo_ventana = "Tensión pu lv fase a por bus. Fecha: " + fecha
    titulo_grafico = titulo_ventana
    x_label = "Hora"
    y_label = "Tensión (pu)"
    output_file = "hola"
    
    plot_dataframe(dataframe, titulo_grafico, 
				   titulo_ventana=titulo_ventana, x_label=x_label,
				   y_label=y_label, rotacion=0, output_file=output_file,
				   save_csv=True)
